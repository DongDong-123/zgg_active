...
def clue(res):
    clue_db = "clue"
    all_clue_type = [u'双软认证', u'ISO9001质量管理体系认证', u'软件产品登记测试报告', u'科技成果评价', u'贯标申请服务',
                     u'知识产权保护', u'专利风险预警', u'专利侵权对抗',
    ...
    for clue_type in [all_clue_type, clue_1_2, clue_1_3, clue_1_4]:
